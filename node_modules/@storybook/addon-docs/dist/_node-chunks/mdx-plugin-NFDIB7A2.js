...
import {
  compile
} from "./chunk-KW4EJUNP.js";
import "./chunk-BHH2RVLW.js";
import "./chunk-U4CKLZTP.js";
import {
  __commonJS,
  __toESM
} from "./chunk-YUGM3N2I.js";
...
async function mdxPlugin(options) {
  let filter = createFilter(/\.mdx$/), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-LE5AS6RC.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-HDG6OFHN.js")).default;
  return {
