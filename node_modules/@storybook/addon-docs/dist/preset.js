import CJS_COMPAT_NODE_URL_sapgoojbiod from 'node:url';
import CJS_COMPAT_NODE_PATH_sapgoojbiod from 'node:path';
import CJS_COMPAT_NODE_MODULE_sapgoojbiod from "node:module";

var __filename = CJS_COMPAT_NODE_URL_sapgoojbiod.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_sapgoojbiod.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_sapgoojbiod.createRequire(import.meta.url);

// ------------------------------------------------------------
// end of CJS compatibility banner, injected by Storybook's esbuild configuration
// ------------------------------------------------------------
import "./_node-chunks/chunk-YUGM3N2I.js";
...
async function webpack(webpackConfig = {}, options) {
  let { module = {} } = webpackConfig, { csfPluginOptions = {}, mdxPluginOptions = {} } = options, enrichCsf = await options.presets.apply("experimental_enrichCsf"), rehypeSlug = (await import("./_node-chunks/rehype-slug-LE5AS6RC.js")).default, rehypeExternalLinks = (await import("./_node-chunks/rehype-external-links-HDG6OFHN.js")).default, mdxLoaderOptions = await options.presets.apply("mdxLoaderOptions", {
    ...mdxPluginOptions,
    mdxCompileOptions: {
...
var docs = (input = {}, options) => {
  ...
  let { plugins = [] } = config, { mdxPlugin } = await import("./_node-chunks/mdx-plugin-NFDIB7A2.js"), { react, reactDom, mdx } = await getResolvedReact(options), packageDeduplicationPlugin = {
