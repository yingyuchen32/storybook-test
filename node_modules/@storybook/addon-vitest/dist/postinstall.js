import CJS_COMPAT_NODE_URL_s72sao07bd from 'node:url';
import CJS_COMPAT_NODE_PATH_s72sao07bd from 'node:path';
import CJS_COMPAT_NODE_MODULE_s72sao07bd from "node:module";

var __filename = CJS_COMPAT_NODE_URL_s72sao07bd.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_s72sao07bd.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_s72sao07bd.createRequire(import.meta.url);
...
import {
  any
} from "./_node-chunks/chunk-WUUPVOLT.js";
import {
  DOCUMENTATION_LINK
} from "./_node-chunks/chunk-S2HJLJEA.js";
import {
  require_dist
} from "./_node-chunks/chunk-YDGW7PA3.js";
import {
  dirname,
  normalize,
  relative,
  resolve
} from "./_node-chunks/chunk-YR2X4D7R.js";
import {
  require_compare,
  require_constants,
  require_debug,
  ...
  require_re,
  require_semver
} from "./_node-chunks/chunk-SZY4IHL5.js";
import {
  __commonJS,
  __toESM
} from "./_node-chunks/chunk-MMRUYBLF.js";
...
async function getTemplatePath(name) {
  switch (name) {
    case "vitest.config.template":
      return import("./_node-chunks/vitest.config-4KQNOXA5.js");
    case "vitest.config.4.template":
      return import("./_node-chunks/vitest.config.4-S6RZKLZJ.js");
    case "vitest.config.3.2.template":
      return import("./_node-chunks/vitest.config.3.2-RFIGLEA3.js");
    case "vitest.workspace.template":
      return import("./_node-chunks/vitest.workspace-FMDZRE7M.js");
    default:
