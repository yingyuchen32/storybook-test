...
declare const _default: () => storybook_internal_csf.PreviewAddon<DesignTypes>;

export { type Config, type DesignTypes, ParameterName as PARAM_KEY, PanelName, config, _default as default };
