...
`;var Z=({config:e})=>jsx("div",{css:g0},jsx(Link,{cancel:false,href:e.url,target:e.target??"_blank",rel:e.rel??"noopener",withArrow:e.showArrow??true},e.label||e.url));var g0=css`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
`,x=({children:e,collapsable:t=true,defaultCollapsed:a=false,placeholder:l,showLink:r=true,onCollapsedChange:n,...i})=>{let[c,g]=useState(!!a),M=r&&"url"in i;return h__default.createElement(V0,null,h__default.createElement(P0,{collapsed:t&&c,...i},t&&c?h__default.createElement(S0,null,l):e,h__default.createElement(ActionBar,{actionItems:[t&&{title:c?"Show":"Hide",onClick:()=>{let v=!c;n&&n(v,c),g(v);}},M&&{title:"Open in new tab",onClick:()=>window.open(i.url,"_blank")}].filter(v=>!!v)})))},a5=({placeholder:e,...t})=>h__default.createElement(x,{placeholder:e??"Design (Figma)",...t},h__default.createElement(b,{config:{type:"figma",...t}})),l5=({placeholder:e,...t})=>h__default.createElement(x,{placeholder:e??"Design (Figma-Spec)",...t},h__default.createElement(c,{config:{type:"figspec",...t}})),r5=({placeholder:e,...t})=>h__default.createElement(x,{placeholder:e??"Design (iframe)",...t},h__default.createElement(a,{config:t})),n5=({placeholder:e,...t})=>h__default.createElement(x,{placeholder:e??"Design (Image)",...t},h__default.createElement(C,{config:{type:"image",...t}})),b0=styled.div`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
